...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="mb-4">
                    <a href="{{ route('category#list') }}" class="au-btn au-btn-icon au-btn--small back-btn">Back</a>
                </div>
                ...
                <form action="{{ route('category#update', $category->id) }}" method="post" enctype="multipart/form-post">
                    @csrf
