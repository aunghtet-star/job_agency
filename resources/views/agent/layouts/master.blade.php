...
{{--                        </li>--}}
                        ...
                        <li>
                            <a href="{{route('agent#job#list')}}" class="text-white">
                                <i class="fas fa-list"></i>Job Posts</a>
                        </li>
                        <li>
                            <a href="{{route('agent#apply#list')}}" class="text-white">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <div>
                                <h4 class="text-white">Agent Dashboard Panel</h4>
                            </div>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('agent#changePasswordPage') }}">
