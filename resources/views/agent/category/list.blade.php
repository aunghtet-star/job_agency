                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a href="{{ route('agent#category#createPage') }}">
                    ...
                    <div class="col-3 offset-9">
                        <form action="{{ route('agent#category#list') }}" method="GET">
                            @csrf
                            <div class="d-flex">
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="{{ route('agent#category#details', $category->id) }}">
                                                    ...
                                                    <a href="{{ route('agent#category#delete', $category->id) }}">
